...
# Asynchronous execution of SQLite and ART maintenance
(
    if command -v sqlite3 >/dev/null 2>&1; then
        echo "[🛠️] Maintenance: sqlite3 found, starting database optimization..." >> "$LOG_FILE"
        ...
        echo "[⚠️] Maintenance: sqlite3 not found, skipping optimization" >> "$LOG_FILE"
    fi
